"""
Camp 2 steering file: single photon gun, 500 um MAPS ECAL geometry.

Changes from cld_steer.py baseline:
  - SIM.compactFile  : local geometry with 500 um cells, 12 um Si
...
SIM.outputFile = f"Output/scan_passiveSi_eta03/photon_{int(_energy_gev)}GeV_500um_SIM.edm4hep.root"
SIM.printLevel = 3
SIM.runType = "batch"
SIM.skipNEvents = 0
...
SIM.gun.direction  = (0.956, 0, 0.292)   # eta = 0.3   # +x: perpendicular to beam, into barrel ECAL
