...
SIM.compactFile = os.path.join(os.environ["CAMP2_DIR"], "geometry/CLD_o2_v07_50um/CLD_o2_v07.xml")
...
SIM.outputFile = f"Output/scan_passiveSi_eta03/photon_{int(_energy_gev)}GeV_50um_SIM.edm4hep.root"
SIM.printLevel = 3
SIM.runType = "batch"
SIM.skipNEvents = 0
