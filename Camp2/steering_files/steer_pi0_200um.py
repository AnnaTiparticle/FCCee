...
SIM.compactFile = os.path.join(os.environ["CAMP2_DIR"], "geometry/CLD_o2_v07_200um/CLD_o2_v07.xml")
...
SIM.outputFile = f"Output/pi0scan/pi0_{int(_energy_gev)}GeV_200um_SIM.edm4hep.root"
SIM.printLevel = 3
SIM.runType    = "batch"
SIM.skipNEvents = 0
