...
SIM.outputFile = f"Output/pi0scan/pi0_{int(_energy_gev)}GeV_baseline_SIM.edm4hep.root"
SIM.printLevel = 3
SIM.runType    = "batch"
SIM.skipNEvents = 0
